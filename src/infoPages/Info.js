...
import { features, icon } from './features'
        ...
        return (
            <TouchableOpacity key={index} onPress={()=>navigation.navigate(item.name)}>
                <View style={{ flexDirection: "row", paddingVertical: 20 }}>
                    <Image width={15} height={15} source={require('../../assets/img/icon/support.png')} style={{ marginRight: 24 }} />
        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={{ width: "100%" }}>
                ...
                <View style={{ padding: 20 }}>
                    ...
                    <Text style={{ marginTop: 12, fontSize: 12, lineHeight: 20, color: "#828282" }}>Please do not disclose your SMS verification code to anyone, including Zerotech's customer support</Text>
                </View>
            </View>
...
const styles = StyleSheet.create({
    ...
    verifyBtn: { backgroundColor: "#FAD939", borderRadius: 20, transform: ([{   translateX: 30 }]), flexDirection: "row", paddingVertical: 5, paddingHorizontal: 20, alignItems: "center" }
})
